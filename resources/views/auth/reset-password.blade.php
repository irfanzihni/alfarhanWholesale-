    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-emerald-100">
            <div class="bg-gradient-to-r from-emerald-600 to-teal-600 px-8 py-6">
                ...
                <h2 class="mt-4 text-center text-3xl font-extrabold text-white tracking-tight">Reset Password</h2>
                <p class="mt-2 text-center text-sm text-emerald-100">Enter your email and choose a new password.</p>
            </div>
